    ...
    <>
      ...
      {searchTextQuery ? (
        ...
        {today.length > 0 && (
          ...
          {tomorrow.length > 0 && (
            <>
            <ProgressTitle>Tomorrow Task <LinkTaskAll href="#">See All</LinkTaskAll></ProgressTitle>
            {tomorrow.map(item =>
              <CardTask 
                key={item.id} 
                id={item.id} 
          ...
          {future.length > 0 && (
            <>
              <ProgressTitle>Future Tasks <LinkTaskAll href="#">See All</LinkTaskAll></ProgressTitle>
              {future.map(item =>
                <CardTask 
                  key={item.id} 
                  id={item.id} 
