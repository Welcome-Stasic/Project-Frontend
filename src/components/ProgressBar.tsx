...
const ProgressBar = observer(() => {
  ...
  return (
    <>
      <ProgressTitle>
        Progress <LinkTaskAll href="#">See All</LinkTaskAll>
      </ProgressTitle>
      <ProgressBarContainer>
        <div className="md-text">Tasks for today</div>
        <div
          style={{
            color: "#FFFFFFCC",
            fontSize: "16px",
        ...
        >
          {store.todayProgress.completed}/{store.todayProgress.total} task
          completed
        </div>
        <div
          style={{
        ...
        >
          ...
          >
            {store.todayProgress.procent}%
          </div>
        </div>
        <ProgressBarBack>
          <ProgressBarFront
            style={{ width: `${store.todayProgress.procent}%` }}
          ></ProgressBarFront>
        </ProgressBarBack>
      </ProgressBarContainer>
    </>
